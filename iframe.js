...
class IframeTest {
  ...
  getTemplateStr() {
    ...
    const scripts = `
            <!-- v2paged.polyfill.min.js rendering is not normal. home page header is missing --> 
            <script src="./v2paged.polyfill.min.js" type="text/javascript"></script>
         
            <!-- paged.polyfill.min.js is rendering normal. home page header is not missing -->
            <!--   
            <script src="./paged.polyfill.min.js" type="text/javascript"></script>
            -->
